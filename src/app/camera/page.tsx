  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* Camera Header - update to match appointments page style */}
        <div className="w-full flex flex-col items-start mb-4 mt-2">
          <h1 className="text-5xl font-bold text-[#1c788c] mb-2 font-poppins leading-tight">Camera</h1>
        </div>

        {/* Device Selector */}
        <div className="card">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-bold text-[#1c788c]">Camera Device</h3>
            <button
        ...
        {/* Camera Settings */}
        <div className="card">
          <h3 className="text-lg font-bold text-[#1c788c] mb-4">Camera Settings</h3>
        ...
        {/* Switch to AI Camera Section */}
        <div className="mt-8 p-6 bg-white border border-[#aedae8] rounded-2xl shadow flex flex-col items-start">
          <span className="text-lg font-bold text-[#1c788c] mb-4">Switch to AI Camera</span>
          <a
            href="https://teachablemachine.withgoogle.com/models/gtpl7P1SP/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-4 py-2 bg-[#74a8bc] text-white rounded-lg font-bold shadow hover:bg-[#86c4d7] transition"
          >
